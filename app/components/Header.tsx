...
import { useHeader, localeOptions } from "./HeaderProvider";
          ...
          <div className="flex items-center">
            <div className="relative">
              <select
                ...
                className="appearance-none bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-lg px-3 py-2 pr-8 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none cursor-pointer hover:bg-white transition-colors"
              >
